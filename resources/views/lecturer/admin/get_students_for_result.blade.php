@extends('layouts.admin_head')
    ...
    @section('get_students_for_result')
                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{route('lecturer.admin.get_students_for_result.get')}}" method="GET" enctype="multipart/form-data" id="multipleValidation">
                                {{-- @csrf --}}
                                <div class="grid md:grid-cols-2 gap-6">
                                  ...
                                  <div class="input-area">
                                    ...
                                    <select name="faculty_id" id="facultySelect" class="form-control w-full mt-2" onchange="showValues(this.value)">
                                  ...
                                  @else
                                        ...
                                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700" id="studentList">
                                          ...
                                          <tr>
                                            ...
                                            <td class="table-td ">
                                              <a href="/lecturer/admin/upload_result/{{$student->id}}&{{$student->name}}">View Courses</a>
                                            </td>
