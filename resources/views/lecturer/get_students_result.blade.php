                        ...
                        <div class="lg:col-span-12 col-span-12">
                            <div class="card h-full">
                              <header class="card-header">
                                <h4 class="card-title">Get Student</h4>
                              </header>
      
                              <div class="card-body p-6">
                                <div class="card-text h-full">
                                  
                                  <form class="space-y-4" action="{{route('lecturer.get_students_result.get')}}" method="GET" enctype="multipart/form-data" id="multipleValidation">
                                      ...
                                      <div class="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div class="input-area" hidden>
                                          ...
                                          <div class="relative">
                                            <input id="faculty_id" type="text" name="faculty_id" value="{{Auth::guard('lecturer')->user()->faculty_id}}" class="form-control" placeholder="{{Auth::guard('lecturer')->user()->faculty->faculty_name}}" required="required" readonly>
                                          </div>
                                        </div>
    
                                      <div id="loading" style="display:none">
                                        <img src="{{asset('assets/images/logo/lsuc_logo.jpeg')}}"><span class="sr-only">Loading...</span>
                                      </div>

                                      <div class="input-area" hidden>
                                          <label for="department_id" class="form-label">Department: </label>
                                          <div class="relative">
                                            <input id="department_id" type="text" name="department_id" value="{{Auth::guard('lecturer')->user()->department_id}}" class="form-control" placeholder="{{Auth::guard('lecturer')->user()->department->department_name}}" required="required" readonly>
                                          </div>
                                        </div>
                                          ...
                                          bg-success-500">
                                            ...
                                            <td class="table-td ">
                                              <div class="flex space-x-3 rtl:space-x-reverse">
                                                <a href="/lecturer/check_result/{{$student->id}}&{{$student->name}}">
