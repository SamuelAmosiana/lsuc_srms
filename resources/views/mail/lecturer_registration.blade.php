...
Temporary Password: {{$lecturer->email}} (Please change your password upon first login for safety!!!)

Getting Started:

Login: Visit http://127.0.0.1:8000/lecturer and use the credentials above to log in. 
