...
<head>
  ...
  <title>Reset Password || Lusaka South College - Portal</title>
    ...
    <div class="lg-inner-column">
      ...
      <div class="lg:w-1/2 w-full flex flex-col items-center justify-center">
        <div class="auth-box-3">
          ...
          <!-- BEGIN: Login Form -->
          <form class="space-y-4" action='{{route('reset_password.post')}}' method="POST">
            @csrf
            ...
            <div class="fromGroup">
                <label class="block capitalize form-label">Matric. No.</label>
                <div class="relative ">
            ...
            <button class="btn btn-green block w-full text-center">Reset Password</button>
          </form>
        </div>
      </div>
